  ...
  return (
    <div className="flex flex-col gap-8 p-8 min-h-full bg-[#FAFCFF] dark:bg-gray-950">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Checklist - Onboarding</h1>
        ...
        <div className="flex items-center gap-3">
          ...
          <div className="relative">
            <button
              ...
              className="flex items-center justify-between gap-2.5 px-4 py-3 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl text-xs font-bold text-gray-900 dark:text-white transition-colors hover:bg-gray-50 dark:hover:bg-gray-800"
            >
            ...
            {isOfficeDropdownOpen && (
              <div className="absolute right-0 mt-2 w-44 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl shadow-lg z-50 overflow-hidden">
          ...
          <div className="relative">
            ...
            {isStatusDropdownOpen && (
              <div className="absolute right-0 mt-2 w-36 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl shadow-lg z-50 overflow-hidden">
                {["In Progress", "Completed"].map((status) => (
                  <button
                    key={status}
                    onClick={() => {
                      setStatusFilter(status as "In Progress" | "Completed");
      ...
      <div className="flex flex-col gap-4">
        {filteredEmployees.map((emp) => {
          ...
          return (
            <Card
              key={emp.id}
              className="border border-gray-50/50 dark:border-gray-800/40 bg-white dark:bg-gray-900 shadow-sm overflow-hidden flex flex-col transition-all duration-300"
            >
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  ...
                  {emp.avatar ? (
                    ...
                    <div className="w-10 h-10 rounded-full bg-emerald-50 dark:bg-emerald-950/30 text-emerald-600 dark:text-emerald-400 flex items-center justify-center text-xs font-bold">
                      {emp.initials}
                    </div>
                  )}
                              ...
                              <div className="flex items-center gap-3">
                                <div className="relative flex items-center justify-center">
                                  <input
                                    ...
                                    className="w-4.5 h-4.5 rounded-full border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 appearance-none checked:bg-primary checked:border-primary cursor-pointer transition-all flex items-center justify-center"
                                  />
                                  {task.completed && (
                                    <svg
        ...
        {filteredEmployees.length === 0 && (
          <div className="py-16 text-center bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 text-xs text-gray-400 dark:text-gray-500">
            No onboarding employees found matching your search.
          </div>
        )}
      </div>
    </div>
