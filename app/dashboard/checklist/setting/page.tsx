  ...
  return (
    <div className="flex flex-col gap-8 p-8 min-h-full bg-[#FAFCFF] dark:bg-gray-950">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        {/* Left Tab Panel */}
        <Card className="lg:col-span-4 p-4 border border-gray-50/50 dark:border-gray-800/40 bg-white dark:bg-gray-900 shadow-sm flex flex-col gap-2 rounded-2xl">
          <button
        ...
        <Card className="lg:col-span-8 p-8 border border-gray-50/50 dark:border-gray-800/40 bg-white dark:bg-gray-900 shadow-sm rounded-2xl flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-4">
            {activeTemplates.map((template) => (
              <div
                key={template.id}
                className="p-6 border border-gray-100 dark:border-gray-800/80 rounded-2xl flex items-center justify-between gap-4 bg-white dark:bg-gray-900 hover:shadow-xs transition-shadow"
              >
                <div>
