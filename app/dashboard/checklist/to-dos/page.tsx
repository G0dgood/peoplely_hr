                    ...
                    <div className="flex items-center gap-3.5">
                      ...
                      >
                        <input
                          ...
                          className="w-5 h-5 rounded-full border border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-900 appearance-none checked:bg-primary checked:border-primary cursor-pointer transition-all flex items-center justify-center"
                        />
                        {task.completed && (
                          <svg
