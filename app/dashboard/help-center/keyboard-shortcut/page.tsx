    ...
    <div className="flex flex-col gap-8 p-8 min-h-full bg-[#FAFCFF] dark:bg-gray-950">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="relative w-full md:w-80">
          <input
            ...
            className="w-full h-12 pl-4 pr-11 rounded-xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 text-xs font-bold text-gray-900 dark:text-white placeholder:text-gray-300 dark:placeholder:text-gray-600 focus:outline-none focus:border-primary focus:ring-1 focus:ring-primary/20 transition-all"
          />
      ...
      <div className="flex flex-col gap-6 max-w-5xl">
        <div className="flex items-center gap-2 text-base font-bold text-gray-900 dark:text-white">
          <span>Keyboard Shortcut For HRDashboard</span>
          <HiOutlineInformationCircle className="text-gray-400 text-lg" />
        </div>

        <Card className="p-8 border border-gray-50/50 dark:border-gray-800/40 bg-white dark:bg-gray-900 shadow-sm flex flex-col gap-6">
          <div>
            <h2 className="text-sm md:text-base font-bold text-gray-900 dark:text-white mb-1.5">
              A list of Keyboard Shortcuts to help you navigate HRDashboard quicker
            </h2>
            <p className="text-xs font-semibold text-gray-400 dark:text-gray-500">
              Here are {SHORTCUTS.length} Keyboard shortcuts that you can use on HRDashboard to save your time.
            </p>
          </div>
          ...
          <div className="overflow-x-auto">
            <Table>
              <TableHeader>
                <TableRow className="border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-900/30">
