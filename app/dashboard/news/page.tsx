        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <div className="relative w-64">
            <Input
              ...
              className="w-full h-11 bg-white dark:bg-gray-900 border-gray-100 dark:border-gray-800 text-xs font-semibold rounded-xl pl-4 pr-10"
            />
            ...
            <div className="flex items-center gap-6">
              ...
              <div className="flex items-center gap-2">
                <Link
                  ...
                  title="Edit news"
                  className="w-8 h-8 rounded-lg border border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800 text-gray-500 dark:text-gray-400 flex items-center justify-center transition-all cursor-pointer"
                >
                ...
                <button
                  ...
                  className="w-8 h-8 rounded-lg border border-gray-100 dark:border-gray-800 hover:bg-red-50 dark:hover:bg-red-950/20 text-red-500 flex items-center justify-center transition-all"
                >
