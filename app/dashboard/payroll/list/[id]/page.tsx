 ...
 return (
  <div className="flex flex-col gap-8 p-8 min-h-full">
   ...
   <Card className="p-8 border border-gray-200 dark:border-gray-800">
    ...
    {/* Employee Info Grid */}
    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-5 pb-8 border-b border-gray-100 dark:border-gray-800 mb-8">
     {[
       ...
       {offset.rows.length > 0 ? (
        <div className="flex flex-col">
         ...
         {offset.rows.map((row, ri) => (
          <div
           key={ri}
           className="grid grid-cols-3 px-6 py-4 border-t border-gray-100 dark:border-gray-800"
          >
     ...
     <SectionRow label="Attendance" value={e.attendance.value} defaultOpen>
      <div className="flex flex-col">
       ...
       {e.attendance.rows.map((row, ri) => (
        <div
         key={ri}
         className="grid grid-cols-2 px-6 py-4 border-t border-gray-100 dark:border-gray-800"
        >
