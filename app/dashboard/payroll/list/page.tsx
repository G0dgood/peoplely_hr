    ...
    <div className="flex flex-col gap-8 p-8 min-h-full">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Manage your team's payroll</p>
        </div>
      ...
      <Card className="p-8 border border-gray-200 dark:border-gray-800">
        <div className="flex flex-col gap-8">
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell className="py-5 px-4 text-right relative">
                        ...
                        {isMenuOpen && (
                          <div className="absolute right-4 mt-1 w-40 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl shadow-xl z-50 overflow-hidden text-left">
                            <button
                            ...
                            {row.status === "PENDING" && (
                              <button
                                ...
                                className="w-full flex items-center gap-2 px-4 py-2.5 text-xs font-semibold text-red-500 hover:bg-red-50 dark:hover:bg-red-950/20 border-t border-gray-100 dark:border-gray-800/60 transition-colors"
                              >
          ...
          {/* Pagination Footer */}
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pt-6 border-t border-gray-200 dark:border-gray-800">
