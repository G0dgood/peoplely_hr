...
function StageDropdown({ stage, onChange }: { stage: Stage; onChange: (s: Stage) => void }) {
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className={`absolute left-0 w-40 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl shadow-xl z-50 py-1 overflow-hidden ${opensUpward ? "bottom-full mb-2" : "top-full mt-2"}`}>
          {STAGES.map((s) => (
            <button
              key={s}
...
function CardActionsDropdown({
  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div className="absolute right-0 mt-1 w-28 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl shadow-xl z-50 py-1 overflow-hidden">
          <button
            onClick={() => {
              onEdit();
              setOpen(false);
      ...
      {stageCandidates.length > 0 ? (
        stageCandidates.map((c) => (
          <Card
            ...
            className={`p-4 border border-gray-200 dark:border-gray-800 cursor-grab active:cursor-grabbing hover:shadow-md transition-shadow bg-white dark:bg-gray-900 rounded-2xl flex flex-col gap-3 ${draggedCandidateId === c.id ? "opacity-50 border-dashed" : ""
              }`}
          >
            {/* Avatar & Name */}
            <div
        ...
        <div className="flex flex-col items-center justify-center border border-dashed border-gray-200 dark:border-gray-800 rounded-2xl p-6 text-center text-gray-400 dark:text-gray-600">
      ...
      {STAGES.map((stage) => {
        ...
        return (
          <div
            ...
            className="flex flex-col gap-4 bg-gray-50/50 dark:bg-gray-900/30 border border-gray-200 dark:border-gray-800 rounded-3xl p-4 min-h-[450px] w-[290px] shrink-0"
          >
            {/* Stage Header */}
  ...
  return (
    <div className="fixed inset-0 z-[100] flex justify-end">
      ...
      <div className="relative w-full max-w-xl bg-white dark:bg-gray-900 h-full shadow-2xl flex flex-col z-10 animate-in slide-in-from-right duration-300">
        ...
        <button
          onClick={onClose}
          className="absolute top-1/2 -left-20 -translate-y-1/2 w-10 h-10 bg-white dark:bg-gray-800 rounded-full shadow-[0_4px_12px_rgba(0,0,0,0.1)] border border-gray-250 dark:border-gray-700 flex items-center justify-center text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-all hover:scale-105 active:scale-95 z-50 focus:outline-none"
        >
        ...
        <div className="flex-1 overflow-y-auto p-6 flex flex-col gap-6 bg-white dark:bg-gray-900">
          {activeTab === "profile" && (
            <>
              ...
              <div className="flex flex-col gap-4 bg-gray-50/50 dark:bg-gray-800/30 p-5 rounded-2xl border border-gray-100 dark:border-gray-850">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="relative border-l border-gray-200 dark:border-gray-800 ml-2.5 pl-5 flex flex-col gap-5">
          ...
          {activeTab === "email" && (
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-1.5 mt-2">
                ...
                <div className="relative">
                  <select className="w-full bg-white dark:bg-gray-900 border border-gray-250 dark:border-gray-800 rounded-xl px-4 py-3 text-xs font-bold text-gray-700 dark:text-gray-300 focus:outline-none appearance-none cursor-pointer">
              ...
              {/* Email compose card */}
              <div className="border border-gray-200 dark:border-gray-800 rounded-2xl bg-white dark:bg-gray-900 p-5 mt-2 flex flex-col shadow-sm">
                <div className="flex items-center gap-3 border-b border-gray-150 dark:border-gray-850 pb-3">
                  <span className="text-xs font-bold text-gray-400 dark:text-gray-550 w-8">To</span>
                  <div className="flex items-center gap-2">
                    <Avatar src={candidate.avatar} fallback={candidate.fallback} size="sm" className="w-6 h-6 border border-gray-100 dark:border-gray-800" />
                    <span className="text-xs font-bold text-gray-800 dark:text-gray-200">{candidate.name}</span>
                  </div>
                </div>
                <div className="flex items-center gap-2 border-b border-gray-150 dark:border-gray-850 py-3">
                ...
                <div className="flex items-center gap-4 py-2 border-b border-gray-150 dark:border-gray-850 text-gray-400 dark:text-gray-500">
          ...
          {activeTab === "evaluation" && (
            <div className="flex flex-col gap-4">
              ...
              {/* Text editor area */}
              <div className="border border-gray-200 dark:border-gray-800 rounded-2xl overflow-hidden mt-4 bg-white dark:bg-gray-900">
                <div className="flex items-center gap-4 px-4 py-2.5 border-b border-gray-150 dark:border-gray-800 bg-gray-50/30 dark:bg-gray-950/20">
                  <button type="button" className="text-xs font-bold text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">B</button>
                  <button type="button" className="text-xs italic font-bold text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">I</button>
                  <button type="button" className="text-xs underline font-bold text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white">U</button>
            ...
            <div className="flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3">
                {comments.map((comment, index) => (
                  <div key={index} className="bg-gray-50/50 dark:bg-gray-800/30 p-3.5 rounded-xl border border-gray-100 dark:border-gray-800/50">
              ...
              <div className="flex gap-2 mt-2">
                <input
                  ...
                  className="w-full text-xs border border-gray-200 dark:border-gray-800 rounded-xl px-4 py-2 bg-transparent focus:outline-none"
                />
                <button
                  onClick={() => {
                    if (newComment.trim()) {
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex items-start gap-4">
                <Avatar
                  ...
                  fallback="PO"
                  size="sm"
                  className="w-10 h-10 border border-gray-100 dark:border-gray-800"
                />
                <div className="flex flex-col">
        ...
        {activeTab === "evaluation" && (
          <div className="p-6 border-t border-gray-150 dark:border-gray-800 flex justify-end bg-white dark:bg-gray-900">
      ...
      {viewMode === "pipeline" ? (
        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-3xl overflow-hidden">
          <div className="overflow-x-auto">
            <Table>
              <TableHeader>
                <TableRow className="border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/30">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-t border-gray-100 dark:border-gray-800">
            <div className="flex items-center gap-1">
              <button className="w-8 h-8 flex items-center justify-center rounded-lg border border-gray-200 dark:border-gray-800 text-gray-400 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
            ...
            <div className="flex items-center gap-6">
              ...
              <button className="flex items-center gap-2 text-xs font-bold text-gray-700 dark:text-gray-300 border border-gray-200 dark:border-gray-800 rounded-lg px-3 py-1.5 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                Show 8
                <HiOutlineChevronDown className="text-gray-400 text-xs" />
              </button>
            </div>
