  ...
  return (
    <div className="relative" ref={ref}>
      <button
        ...
        className="flex items-center gap-2 px-3 py-1.5 border border-gray-200 dark:border-gray-800 rounded-xl text-xs font-bold text-gray-700 dark:text-gray-300 bg-white dark:bg-gray-900 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
      >
        {cfg.dropdownLabel}
        <HiOutlineChevronDown className={`text-gray-400 text-xs transition-transform duration-200 ${open ? "rotate-180" : ""}`} />
      </button>
      {open && (
        <div className="absolute right-0 mt-2 w-44 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-850 rounded-2xl shadow-xl z-50 overflow-hidden">
  ...
  return (
    <div className="fixed inset-0 z-[100] flex justify-end">
      ...
      <div className="relative w-full max-w-2xl bg-white dark:bg-gray-900 h-full shadow-2xl flex flex-col z-10 animate-in slide-in-from-right duration-300">
        ...
        <button
          onClick={onClose}
          className="absolute top-1/2 -left-12 -translate-y-1/2 w-10 h-10 bg-white dark:bg-gray-800 rounded-full shadow-[0_4px_12px_rgba(0,0,0,0.1)] border border-gray-250 dark:border-gray-700 flex items-center justify-center text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-all hover:scale-105 active:scale-95 z-50 focus:outline-none"
        >
        ...
        <div className="flex items-center gap-6 px-6 py-4 border-b border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-gray-800/10">
            ...
            <>
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className={`w-full h-12 bg-white dark:bg-gray-900 border border-gray-250 dark:border-gray-800 rounded-xl px-4 text-xs focus:outline-none appearance-none cursor-pointer ${
                        employmentType === "" ? "text-gray-400 dark:text-gray-500 font-semibold" : "text-gray-700 dark:text-gray-300 font-bold"
                      }`}
                    >
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className={`w-full h-12 bg-white dark:bg-gray-900 border border-gray-250 dark:border-gray-800 rounded-xl px-4 text-xs focus:outline-none appearance-none cursor-pointer ${
                        department === "" ? "text-gray-400 dark:text-gray-500 font-semibold" : "text-gray-700 dark:text-gray-300 font-bold"
                      }`}
                    >
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className={`w-full h-12 bg-white dark:bg-gray-900 border border-gray-250 dark:border-gray-800 rounded-xl px-4 text-xs focus:outline-none appearance-none cursor-pointer ${
                        office === "" ? "text-gray-400 dark:text-gray-500 font-semibold" : "text-gray-700 dark:text-gray-300 font-bold"
                      }`}
                    >
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="border border-gray-200 dark:border-gray-800 rounded-2xl overflow-hidden bg-white dark:bg-gray-900">
                  <div className="flex items-center gap-4 px-4 py-2.5 border-b border-gray-150 dark:border-gray-850 bg-gray-50/30 dark:bg-gray-955/20 text-gray-400 dark:text-gray-500">
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex flex-col gap-3 mt-1">
                  {invitedMembers.map((member) => (
                    <div
                      key={member.email}
                      className="flex items-center justify-between p-3 border border-gray-150 dark:border-gray-800 rounded-xl bg-gray-50/30 dark:bg-gray-900/50"
                    >
              ...
              <div className="flex flex-col gap-3 mt-4">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="w-6 h-6 flex items-center justify-center border border-gray-200 dark:border-gray-800 rounded-lg text-gray-500 hover:text-gray-800 dark:hover:text-white hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors"
                  >
                ...
                {/* Stages List Card */}
                <div className="border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden bg-white dark:bg-gray-900 divide-y divide-gray-150 dark:divide-gray-855">
        ...
        {/* Footer */}
        <div className="p-6 border-t border-gray-150 dark:border-gray-800 flex justify-end gap-3 bg-white dark:bg-gray-900">
          <button
            onClick={handleBack}
...
function SuccessModal({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-[150] flex items-center justify-center p-4">
      ...
      {/* Modal Container */}
      <div className="relative w-full max-w-[400px] bg-white dark:bg-gray-900 border border-gray-150 dark:border-gray-800 rounded-3xl shadow-2xl p-8 flex flex-col items-center text-center animate-in zoom-in-95 duration-200">
      ...
      <div className="flex flex-col gap-4">
        {jobs.map((job) => {
          ...
          return (
            <Card
              key={job.id}
              className="px-8 py-6 border border-gray-200 dark:border-gray-800"
            >
