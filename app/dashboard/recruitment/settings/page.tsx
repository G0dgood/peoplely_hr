  ...
  return (
    <div className="flex flex-col gap-8 p-8 min-h-full">
        ...
        <Card className="p-8 border border-gray-200 dark:border-gray-800 md:col-span-3">
          ...
          {activeTab === "workflow" && (
            <div className="flex flex-col gap-6">
              ...
              <div className="border border-gray-200 dark:border-gray-800 rounded-2xl overflow-hidden divide-y divide-gray-200 dark:divide-gray-800">
                  ...
                  return (
                    <div
                      ...
                      className={`flex items-center justify-between px-6 py-4 transition-colors select-none ${
                        isDragging ? "opacity-30 bg-gray-50 dark:bg-gray-850" : "bg-white dark:bg-gray-950"
                      ...
                      {!isLocked && (
                        <div className="relative">
                          ...
                          {activeDropdown === stage.id && (
                            <div
                              ref={dropdownRef}
                              className="absolute right-0 top-full mt-1 z-50 w-36 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl shadow-lg py-1.5 flex flex-col gap-0.5"
                            >
                              <button
                                onClick={() => {
          ...
          {activeTab === "tags" && (
            <div className="flex flex-col gap-6 animate-fadeIn">
              ...
              <div className="flex gap-6 border-b border-gray-200 dark:border-gray-800 pb-2.5 mb-2">
                <button
              ...
              {activeSubTab === "tag" && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-2">
                  {tags.map((tag) => (
                    <div
                      key={tag.id}
                      className="border border-gray-200 dark:border-gray-800 rounded-2xl p-5 flex items-center justify-between bg-white dark:bg-gray-950/40 hover:bg-gray-50/30 dark:hover:bg-gray-900/10 transition-colors"
                    >
                      ...
                      <div className="relative">
                        ...
                        {activeTagDropdown === tag.id && (
                          <div
                            ref={tagDropdownRef}
                            className="absolute right-0 top-full mt-1 z-50 w-32 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl shadow-lg py-1 flex flex-col gap-0.5"
                          >
                            <button
                              onClick={() => {
                                setEditingTag(tag);
          ...
          {activeTab === "emails" && (
            <div className="flex flex-col gap-6 animate-fadeIn">
              ...
              <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center justify-between mt-2 mb-2">
                ...
                <div className="relative" ref={stageFilterRef}>
                  <button
                    ...
                    className="flex items-center justify-between gap-2 px-4 py-2.5 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl text-xs font-bold text-gray-700 dark:text-gray-250 hover:bg-gray-50/50 dark:hover:bg-gray-800/50 transition-colors cursor-pointer w-40"
                  >
                  ...
                  {isStageFilterOpen && (
                    <div className="absolute left-0 top-full mt-1.5 z-50 w-44 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 rounded-xl shadow-lg py-1.5 flex flex-col gap-0.5">
                      {["All Stages", "Applied", "Screening", "1st Interview", "2nd Interview", "Offered", "Hired", "Rejected"].map((stage) => (
                        <button
                          ...
                          className={`px-4 py-2 text-left text-xs font-semibold hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors ${
                            stageFilter === stage
                ...
                <div className="relative flex-1 max-w-xs">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-gray-900 border border-gray-250 dark:border-gray-850 rounded-xl text-xs font-semibold text-gray-700 dark:text-gray-250 placeholder-gray-400 focus:outline-none focus:border-primary transition-colors"
                  />
                </div>
              </div>

              {/* Templates table */}
              <div className="border border-gray-255 dark:border-gray-850 rounded-2xl overflow-hidden bg-white dark:bg-gray-950/40">
                <Table>
                  ...
                  <TableBody>
                    {filteredTemplates.length === 0 ? (
                      ...
                      filteredTemplates.map((t) => (
                        <TableRow key={t.id} className="border-b border-gray-200 dark:border-gray-850 hover:bg-gray-50/20 dark:hover:bg-gray-900/10 transition-colors">
                          ...
                          <TableCell className="py-4 px-4 text-center">
                            <div className="flex items-center justify-center gap-2">
                              <button
                                ...
                                className="p-1.5 bg-blue-500 hover:bg-blue-600 text-white rounded-full transition-colors cursor-pointer shadow-sm shadow-blue-500/20"
                              >
                              ...
                              {!t.isLocked && (
                                <button
                                  ...
                                  className="p-1.5 bg-red-500 hover:bg-red-600 text-white rounded-full transition-colors cursor-pointer shadow-sm shadow-red-500/20"
                                >
              ...
              <div className="flex items-center justify-start gap-1.5 mt-2">
                <button className="p-2 border border-gray-200 dark:border-gray-800 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-900 text-gray-400 dark:text-gray-550 transition-colors cursor-pointer">
                  <HiOutlineChevronLeft className="text-xs" />
                </button>
                <button className="px-3.5 py-1.5 bg-emerald-50 dark:bg-emerald-950/35 border border-emerald-250 dark:border-emerald-850 rounded-lg text-xs font-bold text-[#10B981] transition-all cursor-pointer">
                  1
                </button>
                <button className="p-2 border border-gray-200 dark:border-gray-800 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-900 text-gray-400 dark:text-gray-550 transition-colors cursor-pointer">
        ...
        <form onSubmit={handleAddTemplate} className="flex flex-col h-full bg-white dark:bg-gray-950">
          ...
          <ModalContent className="flex-1 overflow-y-auto px-6 py-4 flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-1.5 w-full">
              ...
              <div className="flex flex-col border border-gray-200 dark:border-gray-700 rounded-2xl overflow-hidden focus-within:border-primary focus-within:ring-1 focus-within:ring-primary transition-all">
                {/* Editor Toolbar */}
                <div className="flex items-center gap-1.5 px-4 py-2.5 bg-gray-50/50 dark:bg-gray-900/60 border-b border-gray-200 dark:border-gray-700 flex-wrap">
                  <button
                    type="button"
      ...
      <div className={`fixed inset-0 z-50 overflow-hidden transition-all duration-300 ${
        editingTemplate ? "visible" : "invisible pointer-events-none"
      }`}>
        {/* Backdrop overlay */}
        <div
          onClick={() => setEditingTemplate(null)}
          className={`absolute inset-0 bg-black/40 backdrop-blur-[2px] transition-opacity duration-300 ${
            editingTemplate ? "opacity-100" : "opacity-0"
          }`}
        />

        {/* Sliding Panel */}
        <div className={`absolute top-0 right-0 h-full w-full max-w-xl md:max-w-2xl bg-white dark:bg-gray-950 shadow-2xl flex flex-col transition-transform duration-300 ease-in-out transform ${
          editingTemplate ? "translate-x-0" : "translate-x-full"
        }`}>
          ...
          <div className="absolute top-1/2 -translate-y-1/2 -left-6 z-50">
            <button
              type="button"
              onClick={() => setEditingTemplate(null)}
              className="w-12 h-12 bg-white dark:bg-gray-900 rounded-full flex items-center justify-center shadow-lg border border-gray-150 dark:border-gray-800 hover:scale-105 transition-all cursor-pointer text-gray-700 dark:text-gray-350"
            >
          ...
          {editingTemplate && (
            <form onSubmit={handleSaveTemplate} className="flex flex-col h-full bg-white dark:bg-gray-950">
              {/* Header */}
              <div className="px-8 py-6 border-b border-gray-150 dark:border-gray-800 flex items-center justify-between">
              ...
              <div className="flex-1 overflow-y-auto px-8 py-6 flex flex-col gap-5">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="flex flex-col gap-1.5">
                    ...
                    <div className="flex items-center justify-between px-4 py-3 bg-gray-50 dark:bg-gray-900/60 border border-gray-200 dark:border-gray-800 rounded-xl text-xs font-bold text-gray-500 dark:text-gray-405 cursor-not-allowed">
                ...
                <div className="flex flex-col gap-1.5">
                  ...
                  <input
                    ...
                    className="h-12 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 focus:border-primary focus:ring-1 focus:ring-primary rounded-xl px-4 text-xs font-bold text-gray-800 dark:text-gray-200 focus:outline-none transition-colors"
                  />
                </div>
              ...
              {/* Footer */}
              <div className="px-8 py-5 border-t border-gray-150 dark:border-gray-800 flex items-center justify-end gap-3 bg-gray-50/20 dark:bg-gray-955">
                <Button
                  type="button"
                  variant="outline"
                  onClick={() => setEditingTemplate(null)}
