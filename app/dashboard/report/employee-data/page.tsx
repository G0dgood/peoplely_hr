  ...
  return (
    <div className="flex flex-col gap-6 p-8 min-h-full bg-[#FAFCFF] dark:bg-gray-950">
      ...
      <div className="flex flex-col lg:flex-row gap-6 mt-2">
        ...
        <Card className="w-full lg:w-72 p-4 border border-gray-100 dark:border-gray-800/80 bg-white dark:bg-gray-900 rounded-2xl h-fit flex flex-col gap-1.5 shadow-xs">
          {tabs.map((tab) => {
        ...
        <Card className="flex-1 p-8 border border-gray-100 dark:border-gray-800/80 bg-white dark:bg-gray-900 rounded-2xl shadow-xs flex flex-col gap-8">
          {/* Section Header */}
