      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        {REPORT_CARDS.map((card, index) => (
          <Link key={index} href={card.href}>
            <Card className="p-8 border border-gray-100 dark:border-gray-800/80 bg-white dark:bg-gray-900 rounded-2xl shadow-xs hover:shadow-md hover:-translate-y-0.5 transition-all duration-300 flex flex-col gap-4 cursor-pointer group h-full">
              {/* Icon badge */}
