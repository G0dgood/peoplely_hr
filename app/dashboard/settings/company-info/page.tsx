          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex gap-3">
              ...
              <input
                ...
                className="flex-1 h-12 rounded-xl text-body-md bg-white border border-gray-200 dark:border-gray-700 hover:border-gray-300 dark:hover:border-gray-600 focus:border-primary focus:ring-1 focus:ring-primary outline-none transition-colors dark:bg-gray-800 dark:text-white placeholder:text-gray-400 pl-4"
              />
            </div>
          </div>
          <Input
