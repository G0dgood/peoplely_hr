...
function OrgNode({
  ...
  return (
    <div className="flex flex-col items-center relative px-2">
        ...
        <div className="absolute top-0 w-full h-6 flex">
          <div
            className={`w-1/2 h-full ${
              !isFirst && !isOnly ? "border-t border-gray-200 dark:border-gray-700" : ""
            }`}
          />
          <div
            className={`w-1/2 h-full ${
              !isLast && !isOnly ? "border-t border-gray-200 dark:border-gray-700" : ""
            }`}
          />
        </div>
      )}
      ...
      {/* Node Box */}
      <div className="relative border border-gray-200 dark:border-gray-700 rounded-full px-5 py-3 bg-white dark:bg-gray-900 shadow-sm flex items-center justify-center min-w-[110px] z-10">
