        ...
        <div className="max-w-4xl flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-4">
            {integrations.map((integration) => (
              <div
                key={integration.id}
                className="p-6 border border-gray-100 dark:border-gray-800 rounded-2xl flex flex-col md:flex-row md:items-start justify-between gap-6 bg-white dark:bg-gray-900 shadow-xs transition-shadow hover:shadow-sm"
              >
