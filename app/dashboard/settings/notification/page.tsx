    ...
    <div className="flex flex-col h-full bg-white dark:bg-gray-900">
      <div className="p-8 flex-1 overflow-y-auto">
        <div className="max-w-4xl flex flex-col">
          ...
          <div className="border border-gray-200 dark:border-gray-800 rounded-2xl p-8 flex flex-col gap-8 bg-white dark:bg-gray-900">
            {/* Header */}
            ...
            <div className="flex flex-col gap-4">
              {notifications.map((notification) => (
                <div
                  key={notification.id}
                  className="flex items-center justify-between p-6 rounded-2xl border border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-900"
                >
