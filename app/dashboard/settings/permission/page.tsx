        ...
        <div className="p-8 flex flex-col gap-8 h-full">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div 
              ...
              className="p-6 border border-gray-200 dark:border-gray-800 rounded-2xl flex flex-col gap-4 cursor-pointer hover:border-[#0FAF7A] hover:bg-emerald-50/10 transition-colors shadow-xs group"
            >
            ...
            {/* Employee Card */}
            <div className="p-6 border border-gray-200 dark:border-gray-800 rounded-2xl flex flex-col gap-4 shadow-xs">
              <div className="flex items-center justify-between">
      ...
      <div className="p-8 flex-1 overflow-y-auto">
        <div className="max-w-4xl flex flex-col gap-8">
          {activeTab === "Permission" ? (
            <>
              {/* Access Info Box */}
              <div className="border border-gray-200 dark:border-gray-800 rounded-2xl p-6 flex items-center justify-between shadow-xs bg-white dark:bg-gray-900">
            ...
            <>
              {/* Member Search Box */}
              <div className="border border-gray-200 dark:border-gray-800 rounded-2xl p-6 flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-xs bg-white dark:bg-gray-900">
                <h3 className="text-sm font-bold text-gray-900 dark:text-white">
                  Add Admin Member
                </h3>
                  ...
                  {MEMBERS.map((member, index) => (
                    ...
                    >
                      <div className="flex-[2] flex items-center gap-3">
                        {member.avatar ? (
                          <img src={member.avatar} alt={member.name} className="w-8 h-8 rounded-full object-cover border border-gray-200 dark:border-gray-800" />
                        ) : (
