...
const HELP_CATEGORIES: HelpCategory[] = [
  ...
  },
  {
    ...
    href: "/help-center/employee-profile",
  },
  {
    icon: <HiOutlineStar />,
    title: "Checklists - On/offboarding",
    description: "Instructions for employees",
    href: "/help-center/checklists",
  },
  {
    icon: <HiOutlineArrowUturnRight />,
    title: "Keyboard Shortcut",
    description: "Instructions for employees",
    href: "/help-center/keyboard-shortcut",
  },
  {
    icon: <HiOutlinePhone />,
  ...
  },
  {
    ...
    href: "/help-center/pricing-plan",
  },
  {
    icon: <HiOutlineChatBubbleLeftRight />,
    title: "Company News",
    description: "Latest news about unpixel studio",
    href: "/help-center/company-news",
  },
  {
