...
export default function MessagePage() {
  ...
  return (
    <div className="flex h-[calc(100vh-80px)] bg-[#FAFCFF] dark:bg-gray-950 overflow-hidden">
      ...
      {/* ── Left Panel ── */}
      <div className="w-[340px] flex-shrink-0 flex flex-col border-r border-gray-300 dark:border-gray-800 bg-white dark:bg-gray-900">
        {/* Search */}
        <div className="px-5 pt-6 pb-4">
          <div className="relative">
            <input
              ...
              className="w-full h-10 pl-4 pr-10 text-xs font-semibold rounded-xl border border-gray-300 dark:border-gray-800 bg-gray-50 dark:bg-gray-800 text-gray-700 dark:text-gray-300 placeholder:text-gray-400 dark:placeholder:text-gray-600 outline-none focus:ring-2 focus:ring-primary/20 transition-all"
            />
      ...
      <div className="flex-1 flex flex-col min-w-0">
        {/* Chat Header */}
        <div className="flex items-center justify-between px-7 h-[72px] border-b border-gray-300 dark:border-gray-800 bg-white dark:bg-gray-900 flex-shrink-0">
        ...
        <div className="flex items-center gap-3 px-7 py-4 border-t border-gray-300 dark:border-gray-800 bg-white dark:bg-gray-900 flex-shrink-0">
          ...
          <input
            ...
            className="flex-1 h-10 px-4 text-xs font-semibold text-gray-700 dark:text-gray-300 placeholder:text-gray-400 dark:placeholder:text-gray-500 bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-800 rounded-xl outline-none"
          />
