    ...
    <div className="flex flex-col gap-8 p-2 md:p-8 min-h-full bg-[#FAFCFF] dark:bg-gray-950">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            title="Delete news"
            className="w-10 h-10 rounded-xl border border-gray-300 dark:border-gray-800 hover:bg-red-50 dark:hover:bg-red-950/20 text-red-500 flex items-center justify-center transition-all bg-white dark:bg-gray-900 shadow-xs"
          >
