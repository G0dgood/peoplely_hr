...
import { CalendarDay, CalendarDayRange } from "@/components/ui/calendar-day";
 ...
 return (
  <div className="flex items-stretch select-none h-10">
   ...
   <div className="flex-1 flex items-center gap-2">
    ...
    <span className={`text-body-sm font-semibold transition-colors ${active
     ? "text-primary"
     : isDark
       ...
       <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="relative h-[600px] overflow-hidden shadow-lg group">
         ...
         <div className="absolute inset-0 p-8 flex flex-col justify-end">
          <img src="/logo/peoplely.svg" alt="Peoplely HR" className="h-5 w-auto mb-4 brightness-0 invert" />
        ...
        <div className="relative h-[600px] overflow-hidden shadow-lg flex flex-col group">
         ...
         <div className="bg-[#11131A] p-10 flex flex-col justify-center h-72">
          <img src="/logo/peoplely.svg" alt="Peoplely HR" className="h-5 w-auto mb-6 brightness-0 invert" />
       ...
       <div className="flex gap-6 items-start">
        ...
        <div className="h-[800px] w-60 shadow-xl rounded-2xl overflow-hidden border border-gray-800 bg-[#11131A] text-white flex flex-col transition-all duration-300 hover:shadow-2xl">
         <div className="flex items-center justify-between px-4 py-5 border-b border-gray-800/60">
          <img src="/logo/peoplely.svg" alt="Peoplely HR" className="h-6 w-auto brightness-0 invert" />
     ...
     <div className="flex flex-col gap-12 bg-gray-50 dark:bg-[#11131A]/50 p-4 sm:p-8 rounded-3xl border border-gray-300 dark:border-gray-800">
      ...
      <header className="w-full h-20 bg-[#11131A] text-white px-6 sm:px-8 flex items-center justify-between rounded-2xl shadow-md border border-gray-800">
       <div className="flex items-center gap-12">
        <img src="/logo/peoplely.svg" alt="Peoplely HR" className="h-5 w-auto brightness-0 invert" />
     ...
     <div className="flex flex-col gap-12 bg-gray-50 dark:bg-gray-900/50 p-6 sm:p-8 rounded-3xl border border-gray-300 dark:border-gray-800 max-w-6xl">
      ...
      <div className="flex flex-col gap-4">
       ...
       <div className="flex flex-wrap gap-2 items-center bg-white dark:bg-[#11131A] p-4 rounded-xl border border-gray-300 dark:border-gray-800">
         ...
         <CalendarDay variant="disabled" day={22} />
         <CalendarDay variant="secondary" day={22} />
         <CalendarDayRange startDay={22} endDay={22} />
       </div>
      </div>
