        ...
        <div className="bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-800 rounded-3xl overflow-hidden">
          ...
          <div className="flex items-center justify-between px-6 py-4 border-t border-gray-300 dark:border-gray-800">
            ...
            <div className="flex items-center gap-6">
              ...
              <button className="flex items-center gap-2 text-xs font-bold text-gray-700 dark:text-gray-300 border border-gray-300 dark:border-gray-800 rounded-lg px-3 py-1.5 hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors">
                Show 8
                <HiOutlineChevronDown className="text-gray-400 text-xs" />
              </button>
            </div>
