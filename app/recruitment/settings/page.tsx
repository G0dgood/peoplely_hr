          ...
          {activeTab === "emails" && (
            <div className="flex flex-col gap-6 animate-fadeIn">
              ...
              <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center justify-between mt-2 mb-2">
                ...
                <div className="relative flex-1 max-w-xs">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-2.5 bg-white dark:bg-gray-900 border border-gray-300 dark:border-gray-850 rounded-xl text-xs font-semibold text-gray-700 dark:text-gray-250 placeholder-gray-400 focus:outline-none focus:border-primary transition-colors"
                  />
                </div>
              </div>
                  ...
                  <TableBody>
                    {filteredTemplates.length === 0 ? (
                      ...
                      filteredTemplates.map((t) => (
                        <TableRow key={t.id} className="border-b border-gray-300 dark:border-gray-850 hover:bg-gray-50/20 dark:hover:bg-gray-900/10 transition-colors">
              ...
              <div className="flex items-center justify-start gap-1.5 mt-2">
                <button className="p-2 border border-gray-300 dark:border-gray-800 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-900 text-gray-400 dark:text-gray-550 transition-colors cursor-pointer">
