        ...
        <div className="max-w-4xl flex flex-col gap-8">
          {activeTab === "Plan" ? (
            <div className="border border-gray-300 dark:border-gray-800 rounded-2xl flex flex-col bg-white dark:bg-gray-900">
              {/* Card Header */}
              <div className="px-6 py-6 flex items-center gap-3 border-b border-gray-300 dark:border-gray-800/50">
                  ...
                  >
                    ...
                    <div className="flex-1">
                      <span className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-widest ${
                        ...
                        'bg-gray-50 text-gray-400 dark:bg-gray-800/50 border border-gray-300 dark:border-gray-800'
                      }`}>
                        {item.status}
                      </span>
                    </div>
