...
export function PolicyCard({ title, sections, className = "" }: PolicyCardProps) {
  return (
    <div
      className={`border rounded-3xl p-6 sm:p-10 shadow-sm bg-white border-gray-100 dark:bg-gray-900 dark:border-gray-800 dark:text-gray-300 ${className}`}
    >
      {/* Header */}
      <div className="flex items-center gap-3 border-b pb-6 mb-6 border-gray-100 dark:border-gray-800">
